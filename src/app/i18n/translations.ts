...
const sr: TranslationDictionary = {
  ...
  'home.hero.eyebrow': 'Клуб малог фудбала',
  ...
  'home.about.eyebrow': 'О клубу',
  'home.about.title': 'Традиција. Страст. Победе.',
  ...
  'seo.home.title': 'КМФ Црвена звезда | Клуб малог фудбала',
  'seo.home.description': 'Званични сајт КМФ Црвена звезда: тим, вести, управа, партнери и футсал заједница.',
