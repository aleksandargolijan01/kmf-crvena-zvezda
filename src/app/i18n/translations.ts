...
const sr: TranslationDictionary = {
  ...
  'home.sponsors.title': 'Партнери',
  'home.statsAria': 'Статистика клуба',
  'home.sponsorMarqueeAria': 'Покретна трака партнера',
  ...
  'home.friends.eyebrow': 'Партнери клуба',
  'home.friends.title': 'Звездаши увек уз вас!',
  'home.friends.cta': 'Погледај све партнере клуба',
  ...
  'friends.hero.eyebrow': 'Партнери клуба',
  'friends.hero.title': 'Партнери клуба',
  'friends.hero.text': 'Компаније и људи који подржавају развој КМФ Црвена звезда кроз партнерске пакете, партнерске активације и дугорочну подршку клубу.',
  'friends.hero.cta': 'ПОСТАНИ ПАРТНЕР',
  'friends.hero.packageLabel': 'Партнерство',
  'friends.hero.packageValue': '4 пакета',
  'friends.hero.packageText': 'четири нивоа партнерства',
  'friends.hero.supportLabel': 'Подршка клубу',
  'friends.hero.supportText': 'партнера уз црвено-бели футсал',
  'friends.package.eyebrow': 'Партнерски пакет',
  'friends.partnersDataAria': 'Подаци о партнерима',
  'footer.quickLinks': 'Брзи линкови',
  'footer.contact': 'Контакт',
  'footer.socialAria': 'Друштвене мреже',
  'footer.becomeSponsor': 'ПОСТАНИ ПАРТНЕР',
  'footer.becomeSponsorText': 'Придружи се партнерима који граде озбиљну црвено-белу футсал причу.',
  'footer.partnerAria': 'Постаните партнер — отворите форму на страници Партнери клуба',
  'partners.loading': 'Учитавање партнера...',
  'partners.error': 'Партнери тренутно нису доступни.',
  'partners.empty': 'Тренутно нема активних партнера за приказ.',
  'footer.copyright': '© 2026 КМФ Црвена звезда. Сва права задржана.',
  'footer.developerCredit': 'Развој и реализација сајта',
  'footer.developerName': 'Александар Голијан',
...
const en: TranslationDictionary = {
  ...
  'nav.news': 'News',
  'nav.friends': 'Partners of the club',
  'nav.contact': 'Contact',
  ...
  'home.sponsors.title': 'Partners',
  'home.statsAria': 'Club statistics',
  'home.sponsorMarqueeAria': 'Partner marquee',
  ...
  'home.friends.eyebrow': 'Partners of the club',
  'home.friends.title': 'Red Star supporters are always with you!',
  'home.friends.cta': 'View all club partners',
  ...
  'friends.hero.eyebrow': 'Club partnerships',
  'friends.hero.title': 'Partners of the club',
  'friends.hero.text': 'Companies and people supporting the development of KMF Crvena zvezda through partnership packages, partner activations and long-term support for the club.',
  'friends.hero.cta': 'BECOME A PARTNER',
  'friends.hero.packageLabel': 'Partnership',
  'friends.hero.packageValue': '4 packages',
  'friends.hero.packageText': 'four levels of partnership',
  'friends.hero.supportLabel': 'Club support',
  'friends.hero.supportText': 'partners supporting red-and-white futsal',
  'friends.package.eyebrow': 'Partnership package',
  'friends.partnersDataAria': 'Partner information',
  'footer.quickLinks': 'Quick links',
  'footer.contact': 'Contact',
  'footer.socialAria': 'Social networks',
  'footer.becomeSponsor': 'BECOME A PARTNER',
  'footer.becomeSponsorText': 'Join the partners building a serious red-and-white futsal story.',
  'footer.partnerAria': 'Become a partner — open the form on the Partners of the club page',
  'partners.loading': 'Loading partners...',
  'partners.error': 'Partners are currently unavailable.',
  'partners.empty': 'There are no active partners to display.',
  'footer.copyright': '© 2026 KMF Crvena zvezda. All rights reserved.',
  'footer.developerCredit': 'Website development and implementation',
  'footer.developerName': 'Aleksandar Golijan',
...
const ru: TranslationDictionary = {
  ...
  'home.sponsors.title': 'Партнёры',
  'home.statsAria': 'Статистика клуба',
  'home.sponsorMarqueeAria': 'Лента партнёров',
  ...
  'home.friends.eyebrow': 'Партнёры клуба',
  'home.friends.title': 'Звездаши всегда рядом с вами!',
  'home.friends.cta': 'Посмотреть всех партнёров клуба',
  ...
  'friends.hero.eyebrow': 'Партнёрство с клубом',
  'friends.hero.title': 'Партнёры клуба',
  'friends.hero.text': 'Компании и люди, поддерживающие развитие КМФ Црвена звезда через партнёрские пакеты, партнерские активации и долгосрочную поддержку клуба.',
  'friends.hero.cta': 'СТАТЬ ПАРТНЁРОМ',
  'friends.hero.packageLabel': 'Партнерство',
  'friends.hero.packageValue': '4 пакета',
  'friends.hero.packageText': 'четыре уровня партнёрства',
  'friends.hero.supportLabel': 'Поддержка клуба',
  'friends.hero.supportText': 'партнёры вместе с красно-белым футзалом',
  'friends.package.eyebrow': 'Партнёрский пакет',
  'friends.partnersDataAria': 'Информация о партнерах',
  'footer.quickLinks': 'Быстрые ссылки',
  'footer.contact': 'Контакты',
  'footer.socialAria': 'Социальные сети',
  'footer.becomeSponsor': 'СТАТЬ ПАРТНЁРОМ',
  'footer.becomeSponsorText': 'Присоединяйтесь к партнерам, которые строят серьезную красно-белую футзальную историю.',
  'footer.partnerAria': 'Стать партнёром — открыть форму на странице Партнёры клуба',
  'partners.loading': 'Загрузка партнёров...',
  'partners.error': 'Партнёры временно недоступны.',
  'partners.empty': 'Нет активных партнёров для отображения.',
  'footer.copyright': '© 2026 КМФ Црвена звезда. Все права защищены.',
  'footer.developerCredit': 'Разработка и реализация сайта',
  'footer.developerName': 'Александар Голијан',
